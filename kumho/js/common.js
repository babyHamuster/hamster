/* header와 footer에 들어가는 공통요소가 포함된다. */
$(document).ready(function(){
    /* 
        header에 마우스를 올리거나
        브라우저가 스크롤 되면 header에 fixed 클래스를 줌
    ...
    */
    ...
    $('header').on('mouseleave' , function(){
        //마우스를 아웃했을때 fixed 클래스를 삭제하는건 맨상단에 있을때만 가능
        if(scrolling <= 0){//scrolling값이 0과 같거나 작을때
    ...
    */
    ...
    /*
        ...
        footer family_site 에 open 클래스 삭제
